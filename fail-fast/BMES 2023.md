...
R01 > 50% of the grants NIH receives. 

# Introduction to the NIH Common Fund
#grants
High risk High reward research program 1/3 of common fund
1 NIH Director's Early Independent Award 'skip the post-doc'
	Tenure track position
2 NIH Director's New Innovator Award 
	Early stage investigator, single PI (has not received r01) $1.5mill/5yr
3 NIH Director's Transformative Research Award
	All career stages, single/multi PI, 200k-2mill/year in direct costs
4 NIH Director's Pioneer Award
	All career stages, single PI, $3.5mill/5yr

None require preliminary data

Other 2/3 of common fund
5 criteria
Transformative, Catalytic, Synergistic, Cross-cutting, and Unique
encourage interdisciplinary collaborations and joint submissions.

Common Fund Data Ecosystem (CFDE)
Encourage the re-use of data

# Opportunities for Biomedical Research Funding (NSF)

Overcoming gaps in research

read the program description, talk to a program director, review projects funded by the program

include suggested reviewers in the proposal

Merit review criteria: Intellectual merit and broader impacts

Education and outreach can satisfy the broader impacts

Priority areas: https://new.nsf.gov/about/budget/fy2024 or search NSF Budget 2024

Engineering Biology and Health Programs-- Disability and Rehabilitation Engineering, and others, but they are not going to be fully funding. How you frame the research is the key thing: if I have human-machine interfaces that are aligning with it, then that would get past.

NIH Review and Funding process is different NSR for review, Funding is talking to program officers (NCI)

Talking to a program officer (SRO) is for EVERYONE, not privileged

Framing is important when it comes to everything. NSF interested in the growing of knowledge, NIH is more for the applications.

# Using Storytelling to Increase Engagement of Early Learners in Biomedical Engineering
Sally Shady

Participation in STEM is limited in underrepresented minorities, potentially from exposure, economic factors, role models, accessibility, and identity.

Outreach, mentorship, hands-on, charter schools with a focus initiatives

These are all 6-12th grade. What about early learners?

Storytelling as a pedagogical approach for introducing concepts.

Introducing new technical content and overall engineering process in a storybook.

Which age group is benefiting most? Learning about 3D-printing.

Toy breaks, how can it be fixed using 3D printing??

Drawing and CADing, iterative process, oh it printed too large. How to improve, using mathematics. 

2nd grade was the most engaged. 

# Quantitative Analysis of Self-Reported  (Professional) Growth Areas among Rising BME Fourth-Year Undergraduates
Timothy Allen

Industry really likes communication, project management, working on teams. 

ABET also requires it

Career goals, Topical interests for capstone projects, prior experience outside of the class, Top 5 self-reported strengths and growth areas/weaknesses.

Binning weaknesses and strengths into more general categories

Most prevalent: 
Strengths: Organization/time management, Teamwork, Communication skills, work ethic, growth mindset, critical thinking, people skills, resilience

Growth areas: Professional communication, Organization/time management, confidence and self-advocacy, technical skills/experience, teamwork, work-life balance, career/networking/interviewing
